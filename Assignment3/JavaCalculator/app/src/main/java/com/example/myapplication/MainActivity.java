...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean isValidExpression(String expression) {
        ...
        // Check for consecutive operators or starting/ending with an operator (excluding minus for negative numbers)
    ...
    private double evaluateFullExpression(String expression) {
        ...
        for (int i = 0; i < expression.length(); i++) {
            ...
            if (Character.isDigit(c) || c == '.') {
                ...
                i--; // Decrease index because it will be incremented by the for loop after continuing
